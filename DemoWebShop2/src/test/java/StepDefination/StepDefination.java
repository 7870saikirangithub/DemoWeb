...
//	    SecondBook secondbook = new SecondBook(driver);
//	    secondbook.clickBook2();
...
//		} catch (Exception e) {
//			System.out.println("Add to cart not Avalliable");
//		}
	   // WebElement addToCartButton = driver.findElement(By.id("(//div[contains(@class,'button')])[4]")); // Adjust the locator as needed
        //assertTrue(addToCartButton.isDisplayed());
	...
	public void he_clicks_on_the_fourthbook() {
		HomePage homepage = new HomePage(driver);
	    homepage.clickBooks();
//	    FourthBook fourthBook= new FourthBook(driver);
//	    fourthBook.clickBook4();
